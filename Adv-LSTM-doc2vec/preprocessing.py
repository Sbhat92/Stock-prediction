...
def main():
    ...
    features = {
        ...
        "preprocessed_embedding1": lambda df : df["embedding1"],
        "preprocessed_embedding2": lambda df : df["embedding2"],
        "preprocessed_embedding3": lambda df : df["embedding3"],
        "preprocessed_embedding4": lambda df : df["embedding4"],
    }

    #raw_data_path = "data/stocknet-dataset/price/raw/*.csv"
    raw_data_path = "data_sentiment/*.csv"
